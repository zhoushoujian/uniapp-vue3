!(function (e, n) {
  ...
  const r = function (e, n) {
      const i = { options: { timestamp: +new Date() }, name: e, arg: n }
      if (a()) {
        if (e === 'postMessage') {
          const r = { data: n }
        ...
        const d = { type: 'WEB_INVOKE_APPSERVICE', args: { data: i, webviewIds: t } }
        ...
        const w = { type: 'WEB_INVOKE_APPSERVICE', args: { data: i, webviewIds: t } }
  ...
  const v = window.swan && window.swan.webView && /swan/i.test(navigator.userAgent)
  const c =
    window.qq && window.qq.miniProgram && /QQ/i.test(navigator.userAgent) && /miniProgram/i.test(navigator.userAgent)
  const p = window.tt && window.tt.miniProgram && /toutiaomicroapp/i.test(navigator.userAgent)
  const _ =
    window.wx &&
    window.wx.miniProgram &&
    /micromessenger/i.test(navigator.userAgent) &&
    /miniProgram/i.test(navigator.userAgent)
  const m = window.qa && /quickapp/i.test(navigator.userAgent)
  const f =
    window.ks &&
    window.ks.miniProgram &&
    /micromessenger/i.test(navigator.userAgent) &&
    /miniProgram/i.test(navigator.userAgent)
  const l = window.tt && window.tt.miniProgram && /Lark|Feishu/i.test(navigator.userAgent)
  const E =
    window.jd &&
    window.jd.miniProgram &&
    /micromessenger/i.test(navigator.userAgent) &&
    /miniProgram/i.test(navigator.userAgent)
  const x = window.xhs && window.xhs.miniProgram && /xhsminiapp/i.test(navigator.userAgent)
  for (
    var S,
      h = function () {
  ...
  S || (S = {})
  const P = typeof webUni !== 'undefined' ? webUni : {}
  if (!P.navigateTo) for (const b in S) i(S, b) && (P[b] = S[b])
