// 采用腾讯eslint-config-alloy的规则：
// 地址：https://github.com/AlloyTeam/eslint-config-alloy
module.exports = {
  extends: ['plugin:vue/base', 'plugin:vue/vue3-essential', '@vue/eslint-config-typescript'],
